...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `student` WHERE CONCAT(`student_name`, `registration_num`) LIKE '%".$valueToSearch."%'";
...
<form  method="post">
  <br>
    <input type="text" name="valueToSearch" class="search" placeholder="student_name/registration_num">
